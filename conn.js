...
const isOwner = [`${setting.ownerNumber}`,"6285748600473@s.whatsapp.net","6285791381170@s.whatsapp.net"].includes(sender) ? true : false
...
"fileName": `Kuro-MD ${ngazap(prefix)}`,
...
*_Seputar kurobot & transaksi_*

${strip}Telpon/Spam blokir 🚫${strip}

_Admin 1 : 0857-4860-0473_
...
const gurbot = '6285748600473@s.whatsapp.net'
...
var bg_lexxy = '6285748600473@s.whatsapp.net'
...
axios.get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=kuroyama911@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
.then(response => {     
...
const listMessage = {
  ...
  footer: '© created by Kuro official',
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created by Kuro official' })
}
console.log(feta)
}
break
...
.then(data => {
var opt = { packname: 'Kuro MD', author: 'By Ydh1._' }
...
var dev = '6285748600473@s.whatsapp.net'
